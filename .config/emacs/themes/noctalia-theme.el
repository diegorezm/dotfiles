...
(let* ((bg "#181211")
      ...
      (on-secondary "#442a23")
      (on-secondary-container "#ffdad2")
      (on-surface "#ede0dd")
      (on-surface-variant "#d8c2bd")
      (on-tertiary "#3c2f04")
      (on-tertiary-container "#f7e1a6")
      (outline-color "#a08c88")
      (outline-variant "#534340")
      (primary "#ffb4a2")
      (primary-container "#7d2c19")
      (secondary "#e7bdb3")
      (secondary-container "#5d4038")
      (shadow "#000000")
      (surface "#181211")
      ...
      (tertiary "#dac58c")
      (tertiary-container "#544519")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#dac58c")
      (on-success "#3c2f04")
      (success-container "#544519")
      (on-success-container "#f7e1a6")
      ;; Map fixed colors to regular colors
      (primary-fixed "#ffb4a2")
      (primary-fixed-dim "#7d2c19")
      (secondary-fixed "#e7bdb3")
      (secondary-fixed-dim "#5d4038")
      (tertiary-fixed "#dac58c")
      (tertiary-fixed-dim "#544519")
      (on-primary-fixed "#5e1605")
      (on-primary-fixed-variant "#ffdad2")
      (on-secondary-fixed "#442a23")
      (on-secondary-fixed-variant "#ffdad2")
      (on-tertiary-fixed "#3c2f04")
      (on-tertiary-fixed-variant "#f7e1a6")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#ede0dd")
      (inverse-primary "#ffb4a2")
      (inverse-surface "#181211")
